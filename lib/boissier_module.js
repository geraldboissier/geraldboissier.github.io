  ...
  publicAPI.initParallaxHeader = function(){
    $('#header_image').visibility({
      ...
      onPassing  : function(calculations) {
        ...
        var newMargin = calculations.percentagePassed*900;
        var outerHeight = window.innerHeight-56*2;

        var total = logoHeight + newMargin;
        console.log( logoHeight + " + "  + newMargin + " = " + total);
